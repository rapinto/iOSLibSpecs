#
#  Be sure to run `pod spec lint requestVersionManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of requestVersionManager in Markdown format.
  ...
  s.homepage     = "https://github.com/rapinto/requestVersionManager"
