#
#  Be sure to run `pod spec lint VersionManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of VersionManager in Markdown format.
  ...
  s.homepage     = "https://github.com/rapinto/VersionManager"
