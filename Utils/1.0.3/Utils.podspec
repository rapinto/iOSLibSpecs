...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of Utils in Markdown format.
  ...
  s.homepage     = "https://github.com/rapinto/Utils"
  ...
  s.source       = { :git => "https://github.com/rapinto/Utils.git", :tag => s.version }
